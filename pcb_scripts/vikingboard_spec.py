...
class VikingBoardSpec:
    ...
    pins = [
        ...
        Pin(19, "USB_A_DP", "USB-A Host D+", PinType.USB, "3.3V", 0, "USB-A host data + (shared GPIO19 with SPI_MISO)", "GPIO19"),
        Pin(20, "USB_A_DN", "USB-A Host D-", PinType.USB, "3.3V", 0, "USB-A host data -", "GPIO20"),
        Pin(21, "USB_A_EN", "USB-A enable", PinType.CONTROL, "3.3V", 0, "Enable USB-A power (shared GPIO21 with I2C_SDA)", "GPIO21"),
        Pin(22, "GND", "Ground", PinType.GROUND, "GND", 0, "USB ground"),
        
        # ========== SPI BUS (Pins 23-32) ==========
        Pin(23, "SPI_SCK", "SPI clock", PinType.SPI, "3.3V", 0, "Shared SPI bus (shared GPIO18 with IR_TX)", "GPIO18"),
        Pin(24, "SPI_MOSI", "SPI MOSI", PinType.SPI, "3.3V", 0, "Master out slave in (shared GPIO23 with IR_RX)", "GPIO23"),
        Pin(25, "SPI_MISO", "SPI MISO", PinType.SPI, "3.3V", 0, "Master in slave out (shared GPIO19 with USB_A_DP)", "GPIO19"),
        Pin(26, "SPI_CS_CC1101", "CC1101 chip select", PinType.SPI, "3.3V", 0, "CC1101 CS active low (shared GPIO5 with PWM3)", "GPIO5"),
        Pin(27, "SPI_CS_NRF24", "NRF24 chip select", PinType.SPI, "3.3V", 0, "NRF24 CS active low (shared GPIO15 with PWM4)", "GPIO15"),
        Pin(28, "SPI_CS_LORA", "LoRa chip select", PinType.SPI, "3.3V", 0, "LoRa E22 CS (shared GPIO13 with HAPTIC_EN)", "GPIO13"),
        Pin(29, "SPI_CS_SD", "SD card chip select", PinType.SPI, "3.3V", 0, "SD card CS active low (shared GPIO14 with AMP_ENABLE)", "GPIO14"),
        Pin(30, "SD_CD", "SD card detect", PinType.GPIO, "3.3V", 0, "Card detect active low (shared GPIO27 with I2S_DATA_OUT)", "GPIO27"),
        Pin(31, "GND", "Ground", PinType.GROUND, "GND", 0, "SPI ground"),
        Pin(32, "GND", "Ground", PinType.GROUND, "GND", 0, "SPI ground"),
        
        # ========== I2C BUS (Pins 33-38) ==========
        Pin(33, "I2C_SCL", "I2C clock", PinType.I2C, "3.3V", 0, "Shared I2C bus, 4.7k pullup (shared GPIO22 with I2S_DATA_IN, MOD1_SCL)", "GPIO22"),
        Pin(34, "I2C_SDA", "I2C data", PinType.I2C, "3.3V", 0, "Shared I2C bus, 4.7k pullup (shared GPIO21 with USB_A_EN, MOD1_SDA)", "GPIO21"),
        Pin(35, "I2C_INT1", "I2C interrupt 1", PinType.GPIO, "3.3V", 0, "Sensor interrupt IMU (shared GPIO35 with ADC3)", "GPIO35"),
        Pin(36, "I2C_INT2", "I2C interrupt 2", PinType.GPIO, "3.3V", 0, "Sensor interrupt (shared GPIO34 with ADC4)", "GPIO34"),
        ...
        Pin(39, "CC1101_GDO0", "CC1101 GDO0", PinType.RF, "3.3V", 0, "CC1101 data/interrupt (shared GPIO32 with FZ_GPIO12)", "GPIO32"),
        Pin(40, "CC1101_GDO2", "CC1101 GDO2", PinType.RF, "3.3V", 0, "CC1101 status (shared GPIO33 with FZ_GPIO11)", "GPIO33"),
        Pin(41, "NRF24_CE", "NRF24 chip enable", PinType.RF, "3.3V", 0, "NRF24 TX/RX mode (shared GPIO4 with PWM2)", "GPIO4"),
        Pin(42, "NRF24_IRQ", "NRF24 interrupt", PinType.RF, "3.3V", 0, "NRF24 interrupt (shared GPIO16 with UART_GPS/LORA_RX)", "GPIO16"),
        Pin(43, "LORA_M0", "LoRa M0 mode", PinType.RF, "3.3V", 0, "LoRa E22 mode pin (shared GPIO25 with I2S_WS, MOD1_GPIO1)", "GPIO25"),
        Pin(44, "LORA_M1", "LoRa M1 mode", PinType.RF, "3.3V", 0, "LoRa E22 mode pin (shared GPIO26 with I2S_BCK, MOD1_GPIO2)", "GPIO26"),
        Pin(45, "LORA_AUX", "LoRa auxiliary", PinType.RF, "3.3V", 0, "LoRa E22 status (shared GPIO17 with UART_GPS/LORA_TX)", "GPIO17"),
        Pin(46, "GPS_PPS", "GPS pulse per second", PinType.GPIO, "3.3V", 0, "1Hz timing pulse (shared GPIO36 with ADC2)", "GPIO36"),
        ...
        Pin(53, "UART_GPS_TX", "GPS UART TX", PinType.UART, "3.3V", 0, "GPS module TX UART2 (shared GPIO17 with LORA_AUX, LORA_TX)", "GPIO17"),
        Pin(54, "UART_GPS_RX", "GPS UART RX", PinType.UART, "3.3V", 0, "GPS module RX UART2 (shared GPIO16 with LORA_RX, NRF24_IRQ)", "GPIO16"),
        Pin(55, "UART_LORA_TX", "LoRa UART TX", PinType.UART, "3.3V", 0, "LoRa E22 TX (shared UART2, shared GPIO17 with GPS_TX, LORA_AUX)", "GPIO17"),
        Pin(56, "UART_LORA_RX", "LoRa UART RX", PinType.UART, "3.3V", 0, "LoRa E22 RX (shared UART2, shared GPIO16 with GPS_RX, NRF24_IRQ)", "GPIO16"),
        Pin(57, "GND", "Ground", PinType.GROUND, "GND", 0, "UART ground"),
        Pin(58, "GND", "Ground", PinType.GROUND, "GND", 0, "UART ground"),
        
        # ========== I2S AUDIO (Pins 59-66) ==========
        Pin(59, "I2S_BCK", "I2S bit clock", PinType.I2S, "3.3V", 0, "Audio bit clock (shared GPIO26 with LORA_M1, MOD1_GPIO2)", "GPIO26"),
        Pin(60, "I2S_WS", "I2S word select", PinType.I2S, "3.3V", 0, "Audio L/R select (shared GPIO25 with LORA_M0, MOD1_GPIO1)", "GPIO25"),
        Pin(61, "I2S_DATA_IN", "I2S mic data", PinType.I2S, "3.3V", 0, "Microphone input (shared GPIO22 with I2C_SCL, MOD1_SCL)", "GPIO22"),
        Pin(62, "I2S_DATA_OUT", "I2S speaker data", PinType.I2S, "3.3V", 0, "Speaker amplifier out (shared GPIO27 with SD_CD)", "GPIO27"),
        Pin(63, "AMP_ENABLE", "Amplifier enable", PinType.CONTROL, "3.3V", 0, "Speaker amp enable (shared GPIO14 with SPI_CS_SD)", "GPIO14"),
        Pin(64, "HAPTIC_EN", "Haptic enable", PinType.CONTROL, "3.3V", 0, "Vibration motor enable (shared GPIO13 with SPI_CS_LORA)", "GPIO13"),
        ...
        Pin(67, "FZ_GPIO1", "GPIO 1", PinType.GPIO, "3.3V", 0, "General purpose I/O (shared GPIO2 with LED_STATUS, PWM1)", "GPIO2"),
        Pin(68, "FZ_GPIO2", "GPIO 2", PinType.GPIO, "3.3V", 0, "General purpose I/O (shared GPIO0 with LED_POWER, BOOT)", "GPIO0"),
        Pin(69, "FZ_GPIO3", "GPIO 3 / ADC1", PinType.ADC, "3.3V", 0, "ADC capable (input only)", "GPIO39"),
        Pin(70, "FZ_GPIO4", "GPIO 4 / ADC2", PinType.ADC, "3.3V", 0, "ADC capable input only (shared GPIO36 with GPS_PPS)", "GPIO36"),
        Pin(71, "FZ_GPIO5", "GPIO 5 / ADC3", PinType.ADC, "3.3V", 0, "ADC capable input only (shared GPIO35 with I2C_INT1)", "GPIO35"),
        Pin(72, "FZ_GPIO6", "GPIO 6 / ADC4", PinType.ADC, "3.3V", 0, "ADC capable input only (shared GPIO34 with I2C_INT2)", "GPIO34"),
        Pin(73, "FZ_GPIO7", "GPIO 7 / PWM1", PinType.PWM, "3.3V", 0, "PWM capable boot strapping (shared GPIO2 with FZ_GPIO1, LED_STATUS)", "GPIO2"),
        Pin(74, "FZ_GPIO8", "GPIO 8 / PWM2", PinType.PWM, "3.3V", 0, "PWM capable (shared GPIO4 with NRF24_CE)", "GPIO4"),
        Pin(75, "FZ_GPIO9", "GPIO 9 / PWM3", PinType.PWM, "3.3V", 0, "PWM capable boot strapping (shared GPIO5 with SPI_CS_CC1101)", "GPIO5"),
        Pin(76, "FZ_GPIO10", "GPIO 10 / PWM4", PinType.PWM, "3.3V", 0, "PWM capable boot strapping (shared GPIO15 with SPI_CS_NRF24)", "GPIO15"),
        Pin(77, "FZ_GPIO11", "GPIO 11", PinType.GPIO, "3.3V", 0, "General purpose I/O (shared GPIO33 with CC1101_GDO2)", "GPIO33"),
        Pin(78, "FZ_GPIO12", "GPIO 12", PinType.GPIO, "3.3V", 0, "General purpose I/O (shared GPIO32 with CC1101_GDO0)", "GPIO32"),
        Pin(79, "FZ_GPIO13", "GPIO 13 / IR_TX", PinType.GPIO, "3.3V", 0, "IR transmitter 940nm LED (shared GPIO18 with SPI_SCK)", "GPIO18"),
        Pin(80, "FZ_GPIO14", "GPIO 14 / IR_RX", PinType.GPIO, "3.3V", 0, "IR receiver 38kHz demod (shared GPIO23 with SPI_MOSI)", "GPIO23"),
        ...
        Pin(86, "MOD1_SCL", "Module 1 I2C clock", PinType.MODULE_SLOT, "3.3V", 0, "I2C bus access (shared GPIO22 with I2C_SCL, I2S_DATA_IN)", "GPIO22"),
        Pin(87, "MOD1_SDA", "Module 1 I2C data", PinType.MODULE_SLOT, "3.3V", 0, "I2C bus access (shared GPIO21 with I2C_SDA, USB_A_EN)", "GPIO21"),
        Pin(88, "MOD1_GPIO1", "Module 1 GPIO 1", PinType.MODULE_SLOT, "3.3V", 0, "Module control/data (shared GPIO25 with I2S_WS, LORA_M0)", "GPIO25"),
        Pin(89, "MOD1_GPIO2", "Module 1 GPIO 2", PinType.MODULE_SLOT, "3.3V", 0, "Module control/data (shared GPIO26 with I2S_BCK, LORA_M1)", "GPIO26"),
        Pin(90, "MOD1_GND", "Module 1 ground", PinType.GROUND, "GND", 0, "Module slot 1 ground"),
        
        # ========== RESERVED & STATUS (Pins 91-98) ==========
        Pin(91, "LED_STATUS", "Status LED", PinType.GPIO, "3.3V", 0, "User status LED (shared GPIO2 with FZ_GPIO1, PWM1)", "GPIO2"),
        Pin(92, "LED_POWER", "Power LED", PinType.GPIO, "3.3V", 0, "Power indicator LED (shared GPIO0 with FZ_GPIO2, BOOT)", "GPIO0"),
        Pin(93, "BOOT", "Boot mode", PinType.CONTROL, "3.3V", 0, "ESP32 boot mode pull low (shared GPIO0 with FZ_GPIO2, LED_POWER)", "GPIO0"),
